  ...
  return (
    <>
      ...
      <div className='text-block'>
        <p>
          Hi there! I am a weaver based in Chicago, IL. I have a B.F.A. from the
          University of Illinois at Urbana-Champaign and an M.A. from the School
          of the Art Institute of Chicago. I love interacting with all levels of
